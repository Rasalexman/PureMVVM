...
class EventsListFragment : BaseToolbarTabViewPagerFragment<EventsListViewModel>() {
    ...
    private val selectedTabColor by unsafeLazy { color(R.color.color_white) }
    private val unselectedTabColor by unsafeLazy { color(R.color.text_secondary) }
