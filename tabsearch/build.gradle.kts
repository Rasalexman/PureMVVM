import resources.Resources.Search.dirs
import resources.Resources.Search.javaDirs
...
android {
    ...
    defaultConfig {
        ...
        versionCode = appdependencies.Builds.Search.VERSION_CODE
        versionName = appdependencies.Builds.Search.VERSION_NAME
